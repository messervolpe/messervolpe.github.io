...
<body class="flex--desk items--start--desk justify--center--desk">
    <header class="card card--s flex justify--space-between flex--col--desk items--center--desk">
            ...
            <nav class="flex--col items--end items--center--desk">
                ...
                <ul class="js-nav">
                    <li><a href="index.html" class="nav__link"><span class="nav__link--active">archive</span></a></li>
    ...
    <main class="card card--m stack--m">
            <div class="flex flex--wrap justify--space-between items--start">
                <h1>archive</h1>
                <button class="btn--secondary js-open">open all</button>
            </div>
        <div class="js-arc-list stack--m"></div>
    </main>
